...
interface PageSectionLayoutProps {
  ...
  features: { title: string; items: { title: string; desc: string; icon: Record<string, unknown> }[] };
    ...
    <div className="bg-background text-foreground transition-colors duration-300 technical-grid">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            {main.image && (
              <motion.div 
                ...
                className="relative"
              >
                <div className="relative z-10 border border-border bg-background overflow-hidden shadow-xl rounded-[32px]">
                ...
                <div className="absolute -bottom-4 -right-4 w-full h-full border border-border bg-slate-50 dark:bg-white/5 -z-10 rounded-[32px]" />
              </motion.div>
            )}
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-card border-b border-border">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 border-t border-l border-border rounded-[24px] overflow-hidden">
            {features.items.map((item, i) => (
              ...
              >
                <div className="w-12 h-12 bg-primary/10 text-primary flex items-center justify-center mb-8 group-hover:bg-primary group-hover:text-white transition-all rounded-2xl">
                  <item.icon size={20} />
                </div>
      ...
      <section className="py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="bg-secondary dark:bg-slate-900 p-12 sm:p-20 border border-border relative overflow-hidden group rounded-[40px]">
            <div className="relative z-10 text-center">
              ...
              <Link 
                to={finalLink} 
                className="inline-flex items-center space-x-3 bg-primary text-white px-10 py-5 font-bold text-sm sm:text-base uppercase tracking-widest hover:bg-white hover:text-primary transition-all active:translate-y-[1px] shadow-xl shadow-primary/20 rounded-[20px]"
              >
