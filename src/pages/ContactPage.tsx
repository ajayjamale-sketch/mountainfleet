...
import { Mail, Phone, MapPin, Send, MessageSquare, Clock, Globe, Linkedin, Twitter, Github, ChevronRight } from 'lucide-react';
              ...
              <form className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" className="w-full bg-background border border-border p-4 text-sm font-bold uppercase tracking-widest outline-none focus:border-primary transition-colors" placeholder="ALEX" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-500">Last Name</label>
                    <input type="text" className="w-full bg-background border border-border p-4 text-sm font-bold uppercase tracking-widest outline-none focus:border-primary transition-colors" placeholder="VANCE" />
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-widest text-slate-500">Corporate Email</label>
                  <input type="email" className="w-full bg-background border border-border p-4 text-sm font-bold uppercase tracking-widest outline-none focus:border-primary transition-colors" placeholder="ALEX@COMPANY.COM" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-widest text-slate-500">Message Intelligence</label>
                  <textarea rows={4} className="w-full bg-background border border-border p-4 text-sm font-bold uppercase tracking-widest outline-none focus:border-primary transition-colors" placeholder="DESCRIBE YOUR FLEET CHALLENGE..." />
                </div>
                <button className="w-full bg-primary text-white py-5 font-black uppercase tracking-[0.2em] flex items-center justify-center gap-3 hover:bg-secondary transition-all">
                  Send Dispatch <Send size={18} />
                </button>
              </form>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                className="p-8 border border-border bg-background hover:border-primary transition-colors"
              >
      ...
      <section className="py-16 sm:py-24 border-b border-border bg-secondary text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-primary text-white px-10 py-5 font-black uppercase tracking-widest hover:bg-white hover:text-primary transition-all">Book Sales Meeting</button>
            <button className="border border-white/20 text-white px-10 py-5 font-black uppercase tracking-widest hover:bg-white/10 transition-all">Download Media Kit</button>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="flex flex-col items-center p-8 border border-border hover:border-primary transition-colors cursor-pointer group">
